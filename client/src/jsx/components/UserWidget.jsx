...
const UserWidget = ({ userId }) => {
	...
	const { data: user,refetch, error, isFetching, isSuccess, isLoading, isError } = useGetUserByIdQuery(userId);
	console.log(user);
   ...
   if (isFetching) {
		return <Skeleton variant="rectangular" animation={"wave"} width={500} height={500} />;
   }
		...
		<WidgetWrapper>
			...
			<Box p="1rem 0">
				...
				<Box display="flex" alignItems="center" gap="1rem">
					...
					<Typography color={medium}>{user?.job}</Typography>
				</Box>
			</Box>
