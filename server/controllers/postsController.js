...
const createPost = asyncWrapper(async (req, res) => {
	...
	// Find all mentioned users by their name
	const mentionedUsers = await User.find({ username: { $in: mentionNames } });
	// Map the array to get only the ObjectId of each user
